...
select * from aluno
where Nota >= '7'; /* Requisito 1 */

select * from aluno
where (Serie = '1°ano') and (Nota >= '8'); /* Requisito 2 */

select P_nome, Nota from aluno; /* Requisito 3 */
...
select * from aluno2
union
select * from professor; /* Requisito 6 */

select P_nome, U_nome from aluno2
intersect
select * from professor; /* Requisito 7 */

select * from aluno2
except
select * from professor; /* Requisito 8 */
